...
contract Token {
  ...
  function balanceOf(address _address) constant returns (uint256 balance);  // Checks amount of tokens specific wallet holds
  function transfer(address _to, uint256 _value) returns (bool success); // transfer _value tokens to wallet _to
...
contract StandardToken is Token {
   ...
   */
  function transfer(address _to, address _value) returns (bool success) {
